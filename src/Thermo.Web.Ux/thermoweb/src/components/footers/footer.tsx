...
export const Footer = ({ companyinfo, year }:
    { companyinfo: string, year: string }) => (
        <div>
            ...
            <div className='l-footer__metadata'>
                <div className='l-footer__legal'>
                    <p>
                        <a href='https://www.google.com/intl/en_nz/policies/' target='_blank' data-g-event='site-footer' data-g-action='clicked' data-g-label='privacy'>
                        Copyright {companyinfo} {year} Privacy Policy
                         </a>
                    </p>
                    <p>
                ...
                <ul className='l-footer__social'>
                    <li>
                        <a href='https://www.instagram.com/android/' rel='nooopener' aria-label='Find Android on Instagram' target='_blank' title='Find Android on Instagram' data-g-event='site-footer-social' data-g-action='clicked' data-g-label='instagram'>
                            <svg aria-hidden='true' role='presentation' className='icon icon--svg icon--social icon--instagram' xmlns='http://www.w3.org/2000/svg' width='32' height='32' viewBox='0 0 48 48'>
                    ...
                    <li>
                        <a href='https://www.youtube.com/user/GoogleMobile' rel='nooopener' aria-label='Find Android on YouTube' target='_blank' title='Find Android on YouTube' data-g-event='site-footer-social' data-g-action='clicked' data-g-label='youtube'>
                            <svg aria-hidden='true' role='presentation' className='icon icon--svg icon--social icon--youtube' xmlns='http://www.w3.org/2000/svg' width='32' height='32' viewBox='0 0 48 48'>
                    ...
                    <li>
                        <a href='https://www.facebook.com/AndroidOfficial' rel='nooopener' aria-label='Find Android on Facebook' target='_blank' title='Find Android on Facebook' data-g-event='site-footer-social' data-g-action='clicked' data-g-label='facebook'>
                            <svg aria-hidden='true' role='presentation' className='icon icon--svg icon--social icon--facebook' xmlns='http://www.w3.org/2000/svg' width='32' height='32' viewBox='0 0 48 48'>
                    ...
                    <li>
                        <a href='https://www.twitter.com/android' rel='nooopener' aria-label='Find Android on Twitter' target='_blank' title='Find Android on Twitter' data-g-event='site-footer-social' data-g-action='clicked' data-g-label='twitter'>
                            <svg aria-hidden='true' role='presentation' className='icon icon--svg icon--social icon--twitter' xmlns='http://www.w3.org/2000/svg' width='32' height='32' viewBox='0 0 48 48'>
                    ...
                    <li>
                        <a href='https://officialandroid.blogspot.com/' rel='nooopener' aria-label='Find Android on Blogger' target='_blank' title='Find Android on Blogger' data-g-event='site-footer-social' data-g-action='clicked' data-g-label='blogspot'>
                            <svg aria-hidden='true' role='presentation' className='icon icon--svg icon--social icon--blogger' xmlns='http://www.w3.org/2000/svg' width='32' height='32' viewBox='0 0 48 48'>
